...
["jest-icon",["medium-red","medium-red"],/^jest(?:\.config)?\.(?:js(?:on|x)?|[cm]js|tsx?)$|^\.jestrc(?:$|\.)/i,2],
...
["eclipse-lang-icon",["medium-blue","medium-blue"],/\.ecl(?:\.txt)?$/i,1.5,false,,/\.eclipse$/i,/^Ecli[\W_ \t]?Pse$/i],
...
["asm-zilog-icon",["medium-blue","medium-blue"],/\.PLX(?:COPY)?$/,1.25,false,,/\.zvm(?:asm|plx|plxedl)(?:\.|$)/,/^Assembly,[\W_ \t]?Zil[0o]g$|^z\/?(?:OS|VM)\s*(?:Assembl(?:y|er)|PL\/?X(?:\s*EDL)?)$/i],
...
["_4d-icon",["dark-blue","dark-blue"],/\.4dm$/i,,false,,/\.4dm$/i,/^4[\W_ \t]?D$/i],
...
["affectscript-icon",["medium-pink","medium-pink"],/\.affect$/i,,false,,/\.affect$/i,/^Affect[\W_ \t]?Script$/i],
...
["amusewiki-icon",["dark-red","dark-red"],/\.muse$/i,,false,,/\.muse$/i,/^Amuse[\W_ \t]?Wiki$|^Muse$/i],
...
["asm-agc-icon",["dark-blue","dark-blue"],/\.agc$/i,,false,,/\.source\.agc$/i,/^Assembly,[\W_ \t]?Agc$|^(?:Virtual\s*)?AGC$|^Apollo(?:[-_\s]*11)?\s*Guidance\s*Computer$/i],
["asm-arm-icon",["medium-blue","medium-blue"],/\.arm$/i,,false,,/\.arm$/i,/^Assembly,[\W_ \t]?Arm$/i],
["asm-avr-icon",["dark-purple","dark-purple"],/\.avr$/i,,false,,/(?:^|\.)avr(?:dis)?asm(?:\.|$)/i,/^Assembly,[\W_ \t]?Avr$/i],
["asm-hitachi-icon",["medium-grey","medium-grey"],/\.h8(?:SX?|\d{3})?$/i],
["asm-intel-icon",["dark-blue","dark-blue"],/\.(?:(?:x|i(?:a[-_]?))(?:32|86|64)(?:asm)?|i386|80386)$/i,,false,,/(?:^|\.)(?:(?:x|i(?:a[-_]?))(?:32|86|64)(?:asm)?|i386|80386)(?:\.|$)/i,/^Assembly,[\W_ \t]?Intel$|^(?:x86|x64|x86[-_]?64|i(?:a[-_]?)?(?:32|64)|i386|80386|Intel|Itanium|[ftm]asm)$/i],
["asm-m68k-icon",["dark-red","dark-red"],/\.m68k$/i,,false,,/(?:^|\.)(?:m68k|dasm)(?:\.|$)/i,/^Assembly,[\W_ \t]?M[0o]t[0o]r[0o]la$|^(?:asm68(?:k|\d{2,3})?|m68k)$/i],
["asm-m68k-icon",["medium-blue","medium-blue"],/\.lst$/i,,false,,/(?:^|\.)(?:lst-)?cpu[-_\s]?12(?:\.|$)/i,/^Assembly,[\W_ \t]?M[0o]t[0o]r[0o]la$|^lst[\W_ \t]?cpu12$/i],
["asm-vax-icon",["medium-maroon","medium-maroon"],/\.v(?:ax|masm)$/i],
["asm-zilog-icon",["medium-yellow","medium-yellow"],/\.z80$/i,,false,,/\.z80$/i,/^Assembly,[\W_ \t]?Zil[0o]g$/i],
...
["bnf-icon",["medium-maroon","medium-maroon"],/\.bnf$/i,,false,/^bnf$/,/\.bnf$/i,/^Backus[\W_ \t]?Naur[\W_ \t]?F[0o]rm$|^bnf$/i],
["bnf-icon",["medium-green","medium-green"],/\.abnf$/i,,false,/^abnf$/,/\.abnf$/i,/^Backus[\W_ \t]?Naur[\W_ \t]?F[0o]rm$|^abnf$/i],
["bnf-icon",["medium-red","medium-red"],/\.ebnf$/i,,false,/^ebnf$/,/\.ebnf$/i,/^Backus[\W_ \t]?Naur[\W_ \t]?F[0o]rm$|^ebnf$/i],
...
["binary-icon",["medium-orange","medium-orange"],/\.(?:gco?|gcode|[cdhk]nc)$/i,,false,/^g-code$/,/\.g-code$/i,/^Binary$|^g[\W_ \t]?c[0o]de$/i],
...
["bison-icon",["medium-red","medium-red"],/\.bison$/i,,false,/^bison$/,/\.bison$/i,/^bis[0o]n$/i],
...
["config-icon",["medium-yellow","medium-yellow"],/\.(?:ini|desktop|directory|cfg|co?nf|prefs)$/i,,false,,/\.ini$/i,/^d[0o]sini$/i],
...
["cuneiform-icon",["dark-blue","dark-blue"],/\.cfl$/i,,false,/^cuneiform$/,/\.cfl$/i,/^Cuneif[0o]rm$/i],
["curl-icon",["dark-blue","dark-blue"],/(?:^|\.)curlrc$|^_curlrc$/i,,false,,/\.curlrc$/i,/^c[\W_ \t]?Url$/i],
...
["database-icon",["medium-orange","medium-orange"],/\.hson$|\.ndjson$|\.dbi$|(?:^|\.)encodings\.dir$/i,,false,/^hson$/,/\.hson$/i,/^hs[0o]n$/i],
...
["database-icon",["dark-green","dark-green"],/\.son$|\.sy$/i,,false,/^son$/,/\.son$/i,/^s[0o]n$/i],
...
["binary-icon",["dark-green","dark-green"],/\.dit(?:roff)?$/i,,false,,/\.source\.ditroff$/i,/^Ditr[0o]ff$/i,/^x\s*T\s+(?:dvi|html|lbp|lj4|ps|post|pdf|ascii|cp1047|latin1|utf8|X75|X75-12|X100|X100-12)(?=\s|$)/],
...
["code-icon",["medium-blue","medium-blue"],/\.xml$|\.config$|\.4th$|\.cocci$|\.dyl$|\.dylan$|\.fcgi$|\.forth$|\.launch$|\.manifest$|\.menu$|\.srdf$|\.st$|\.ui$|\.wsf$|\.x3d$|\.xaml$/i,,false,,/\.smpl$/i,,/^<\?xml /],
...
["code-icon",["medium-red","medium-red"],/\.cscfg$|\.cgi$|\.ch$|\.cw$|\.fo$|\.iml$|\.mask$|\.mumps$|\.prg$|\.pt$|\.rl$|\.sml$|\.targets$|\.tera$|\.webidl$|\.wsdl$|\.xacro$|\.xliff$/i,,false,/^fasto$/,/\.fasto$/i],
...
["code-icon",["medium-blue","medium-blue"],/\.sk[12]$|\.stellaris$/i,,false,/^stellaris$/,/\.stellaris$/i,,/^##sK1 /],
...
["gnuplot-icon",["medium-red","medium-red"],/\.(?:gp|plo?t|gnuplot)$/i,,false,/^gnuplot$/,/\.gnuplot$/i,/^Gnupl[0o]t$/i],
...
["js-icon",["medium-yellow","dark-yellow"],/\.js$|\.es\d?$/i,,false,/^(?:node|chakra|d8|iojs|g?js|qjs(?:c?|bnc?)?|mujs|rhino|slimerjs|v8(?:-shell)?)$/,/\.js$/i,/^Java[\W_ \t]?Script$|^(?:js|node)$/i],
...
["json-icon",["dark-blue","dark-blue"],/\.jsonc$/i,,false,,/\.jsonc$/i,/^Js[0o]n$|^Js[0o]n[\W_ \t]?with[\W_ \t]?C[0o]mments$/i],
...
["jsonnet-icon",["dark-blue","dark-blue"],/\.jsonnet$/i,,false,/^jsonnet$/,/\.jsonnet$/i,/^js[0o]nnet$/i],
...
["markdown-icon",["medium-blue","medium-blue"],/\.(?:md(?:te?xt)?|mdown|markdown|mkd|mkdown|mdwn|mkdn|rmd|ron|pmd)$/i,,false,,/(?:^|\.)[gp]fm|md|markdown(?:\.|$)/i,/^(?:CommonMark|GFM|Pandoc)$|\bMarkdown\b/i],
...
["mirc-icon",["medium-red","medium-red"],/\.mrc$/i,,false,,/\.mrc$/i,/^m[\W_ \t]?Irc$/i],
...
["noon-icon",["dark-grey","dark-grey"],/\.noon$/i,,false,/^noon$/,/\.noon$/i,/^N[0o][0o]n$/i],
...
["oberon-icon",["medium-purple","medium-purple"],/\.ob2$/i,,false,,/\.oberon$/i,/^[0o]ber[0o]n$/i],
...
["odin-icon",["medium-blue","medium-blue"],/\.odin$/i,,false,/^odin$/,/\.odin$/i,/^[0o]din$/i],
["ooc-icon",["medium-green","medium-green"],/\.ooc$/i,,false,,/\.ooc$/i,/^[0o][0o]c$/i],
["opa-icon",["medium-blue","medium-blue"],/\.opa$/i,,false,,/\.opa$/i,/^[0o]pa$/i],
["openpolicy-icon",["medium-cyan","medium-cyan"],/\.rego$/i,,false,,/\.rego$/i,/^[0o]pen[\W_ \t]?P[0o]licy[\W_ \t]?Agent$/i],
...
["pinescript-icon",["medium-green","medium-green"],/\.pine$/i,,false,,/\.pine$/i,/^Pine[\W_ \t]?Script$/i],
...
["terminal-icon",["medium-green","medium-green"],/^\.?_?dir_?colors$/i,,false,/^dircolors$/,/\.dircolors$/i,/^dirc[0o]l[0o]rs$/i],
["terminal-icon",["medium-red","medium-red"],/\.inputrc$/i,,false,,/\.inputrc$/i,/^Readline[\W_ \t]?C[0o]nfig$/i],
...
["sophia-icon",["dark-pink","dark-pink"],/\.aes$/i,,false,,/\.sophia$/i,/^S[0o]phia$/i],
...
["source-icon",["medium-blue","medium-blue"],/\.vmt$/i,,false,,/\.vmt$/i,/^Valve[\W_ \t]?S[0o]urce[\W_ \t]?Engine$|^Valve[\W_ \t]?Material[\W_ \t]?Type$/i],
...
["wasm-icon",["medium-blue","medium-blue"],/\.was?t$/i,,false,/^wasmtime$/,/(?:^|\.)(?:webassembly|was[mt])(?:\.|$)/i,/^Web[\W_ \t]?Assembly$|^was[mti]$/i],
...
["webvtt-icon",["dark-blue","dark-blue"],/\.vtt$/i,,false,,/^source\.vtt$/,/^Web[\W_ \t]?Vtt$/i,/^WEBVTT(?=\s|$)/],
...
["yorick-icon",["medium-orange","medium-orange"],/\.yorick$/i,,false,/^yorick$/,/\.yorick$/i,/^Y[0o]rick$/i],
...
["database-icon",["medium-green","medium-green"],/\/tab\.(?:37|450-12|450|lp|think)$|\/dev[-\w]+\/(?:APL\.bug|[A-Z][-A-Za-z0-9]*)(?:\.fd)?$/i,0.75,true],
...
["model-icon",["medium-green","medium-green"],/\.x$/i,0.5,false,,/(?:^|\.)direct-?x(?:$|\.)/i,/^Direct[\W_ \t]?X[\W_ \t]?3[\W_ \t]?D[\W_ \t]?File$/i,/^xof 0303(?:txt|bin|tzip|bzip)\b/],
...
